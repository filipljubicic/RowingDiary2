...
class ErgosControllerTest < ActionController::TestCase
  ...
  test "should create ergo" do
    assert_difference('Ergo.count') do
      post :create, ergo: { description: @ergo.description, distance: @ergo.distance, hr: @ergo.hr, notes: @ergo.notes, rate: @ergo.rate, split: @ergo.split, time: @ergo.time }
    end
  ...
  test "should update ergo" do
    patch :update, id: @ergo, ergo: { description: @ergo.description, distance: @ergo.distance, hr: @ergo.hr, notes: @ergo.notes, rate: @ergo.rate, split: @ergo.split, time: @ergo.time }
    assert_redirected_to ergo_path(assigns(:ergo))
  end
